...
const inputStyle = { width: "100%", padding: "9px 11px", borderRadius: 9, border: `1px solid ${C.border}`, fontSize: 14, color: C.ink, background: "#fff", outline: "none", fontFamily: FONT };
const smInput = { ...inputStyle, padding: "7px 9px", fontSize: 13 };
  ...
  return (
    <div style={{ fontFamily: FONT, background: C.canvas, minHeight: "100vh", color: C.ink }}>
      <header style={{ position: "sticky", top: 0, zIndex: 50, background: C.navy, boxShadow: "0 2px 14px rgba(11,44,77,0.16)" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 24px", display: "flex", alignItems: "center", gap: 18, height: 60 }}>
      ...
      <div style={{ background: "#fff", borderBottom: `1px solid ${C.border}` }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", padding: "9px 24px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
