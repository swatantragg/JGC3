...
/* ============================================================
   Costing — the Cost Working sheet, live. Rendered as a tab inside
   Other Reports, which supplies the page heading.
  ...
  return (
    <div className="stack">
      ...
      <Card>
        ...
        {rows.length ? (
          <DataTable serial columns={columns} rows={rows} rowKey={(r) => r.id} maxHeight={560} />
        ) : (
